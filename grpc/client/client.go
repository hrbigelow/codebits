...
var (
  ...
  serverHostOverride = flag.String("server_host_override", "x.test.example.com",
           "The server name used to verify the host name returned by the TLS handshake")
)
...
// runRouteChat receives a sequence of route notes, while sending notes to various
// locations
